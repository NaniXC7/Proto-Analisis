...
$query1 = mysqli_query($conexion, "SELECT COUNT(id) AS total FROM sucursal WHERE estado = 1");
$totalSucursales = mysqli_fetch_assoc($query1);
$query2 = mysqli_query($conexion, "SELECT COUNT(id) AS total FROM productos WHERE estado = 1");
$totalProductos = mysqli_fetch_assoc($query2);
        ...
        <div class="row">
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-info">
                    ...
                    <a href="productos.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-success">
                    <div class="inner">
                        <h3><?php echo $totalSucursales['total']; ?></h3>
                    ...
                    <a href="sucursales.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-6">
